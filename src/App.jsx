...
// Use a simple SVG flower logo that always renders correctly
const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
  ...
  <circle cx="60" cy="60" r="58" fill="none" stroke="#c9a84c" stroke-width="1" opacity="0.4"/>
  <!-- Petals -->
  <ellipse cx="60" cy="32" rx="8" ry="18" fill="url(#petal)" opacity="0.9"/>
  <ellipse cx="60" cy="88" rx="8" ry="18" fill="url(#petal)" opacity="0.9"/>
  <ellipse cx="32" cy="60" rx="18" ry="8" fill="url(#petal)" opacity="0.9"/>
  <ellipse cx="88" cy="60" rx="18" ry="8" fill="url(#petal)" opacity="0.9"/>
  <ellipse cx="40" cy="40" rx="8" ry="18" fill="url(#petal)" opacity="0.8" transform="rotate(-45 40 40)"/>
  <ellipse cx="80" cy="40" rx="8" ry="18" fill="url(#petal)" opacity="0.8" transform="rotate(45 80 40)"/>
  <ellipse cx="40" cy="80" rx="8" ry="18" fill="url(#petal)" opacity="0.8" transform="rotate(45 40 80)"/>
  <ellipse cx="80" cy="80" rx="8" ry="18" fill="url(#petal)" opacity="0.8" transform="rotate(-45 80 80)"/>
  <!-- Center -->
  <circle cx="60" cy="60" r="16" fill="#c9a84c"/>
  <circle cx="60" cy="60" r="11" fill="#a07828"/>
  <circle cx="60" cy="60" r="6" fill="#e8c97a"/>
  <!-- JM text -->
  <text x="60" y="64" text-anchor="middle" font-family="serif" font-size="7" font-weight="bold" fill="#0a0a0a">JM</text>
</svg>`;
